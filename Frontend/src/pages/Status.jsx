...
// Status component to display user statuses

const Status = () => {
  // Sample data for user's status and recent updates
  const myStatus = {
    name: "My Status",
    time: "Today, 10:00 AM",
    image: "https://example.com/my-status.jpg", // URL of user's status image
  };
  ...
  return (
    ...
    >
      ...
      {/* Mapping through recent status updates */}
